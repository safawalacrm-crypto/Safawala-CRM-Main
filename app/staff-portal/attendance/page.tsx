...
import { AttendanceExportActions } from '@/components/staff-portal/attendance-export-actions';
...
export default async function AttendancePage() {
  ...
  return <StaffRecordPage session={session} title="My Attendance" subtitle="Your attendance access and daily status" icon={<Clock3 />} heading="Attendance active" description="Your attendance access is enabled.">
    <div className="flex justify-end"><AttendanceExportActions name={session.name} loginId={session.loginId} today={today} /></div>
