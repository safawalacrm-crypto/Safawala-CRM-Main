...
const packageFields =
  'id,name,is_active,created_at,updated_at,package_variants(id,category_id,name,base_price,inclusions,extra_safa_price,missing_safa_penalty,security_deposit,created_at,updated_at)';
